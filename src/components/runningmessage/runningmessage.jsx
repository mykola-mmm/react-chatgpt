...
export default function RunningMessage({
  messages,
  messagesIntervalMs,
  textRenderSpeedMs,
}) {
  ...
  function addLetter() {
    setMessageText(
      isMessageText + messages[isMessageIndex].msgbody[index.current]
    );
    console.log(
      "index current - ",
      index.current,
      " letter - ",
      messages[isMessageIndex].msgbody[index.current]
    );
  ...
  return (
    <div className="running-message">
      <div className={"message " + (isAnimation ? "transition" : "")}>
        <div className="title">{messages[isMessageIndex].title}</div>
        <div className="message-body">
          ...
          <div
            // className={"circle " + (isRenderFinished ? "inactive" : "")}
          ></div>
        </div>
      </div>
    </div>
